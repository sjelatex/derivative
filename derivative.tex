...
\begin{option}{sep-frac-fun}[new = v1.0]
	...
	\begin{example}
		\pdv*[sep-frac-fun=\ms{here}]{f}{x,y}
	\end{example}
\end{option}
...
\begin{option}{sep-var-ord}
	...
	\begin{example}
		\pdv[sep-var-ord=\ms{here}, order=n]{f}{x,y}
	\end{example}
\end{option}
...
\begin{option}{sep-var-inf}
	...
	\begin{example}
		\pdv[sep-var-inf=\ms{here}, order=n]{f}{x,y,z} \\
		\pdv[sep-var-inf=\ms{here}, order=n]{f}!{x,y,z}
	\end{example}
\end{option}
...
\begin{option}{sep-ord-inf}
	\begin{values}[default = \cs{mathop}\{\}\cs{!}]
		\meta{cs-number}, \marg{mspace}, \marg{delimiter}
	\end{values}
	They key sets the math space that is inserted between a order and the following infinitesimal. The space is only inserted when the variable's order \emph{is different} from \num{1}. It is only inserted when more than one non-blank variables are given. The key's default value is \val{\default}.
	\begin{example}
		\pdv[sep-ord-inf=\ms{here}, order=n]{f}{x,y,z}
	\end{example}
\end{option}
...
\begin{option}{sep-ord-ord}[new = v1.3]
	\begin{values}[default = {{,}}]
		\meta{cs-number}, \marg{mspace}, \marg{delimiter}
	\end{values}
	They key sets the math space that is inserted between two orders. The space is only inserted when more than one non-blank variables are given, and the option \keyval{style-var} and its variants is \val{single}. The key's default value is a comma.
	\begin{example}
		\pdv[sep-ord-ord=\ms{here}, order={n,2}]{f}/!{x,y}
	\end{example}
\end{option}
...
\begin{option}{sep-ord-var}[new = v1.3]
	...
	\begin{example}
		\odv[sep-ord-var=\ms{here}, order=n]{f}!{x,y}
	\end{example}
\end{option}
...
\begin{option}{sep-var-var}[new = v1.0]
	\begin{values}[default = {{,}}]
		\meta{cs-number}, \marg{mspace}, \marg{delimiter}
	\end{values}
	They key sets the math space that is inserted between two variables. The space is only inserted when more than one non-blank variables are given, and the option \keyval{style-var} and its variants is \val{single}. The key's default value is a comma.
	\begin{example}
		\pdv[sep-var-var=\ms{here}, style-var=single]{f}{x,y} \\
		\pdv[sep-var-var=\ms{here}]{f}/!{x,y}
	\end{example}
\end{option}
...
\begin{option}{sep-eval-sb}
	...
	\begin{example}
		\pdv[sep-eval-sb=\ms{here}]{f}{x,y}_{(x_1,y_1)}
	\end{example}
\end{option}
...
\begin{option}{sep-eval-sp}
	...
	\begin{example}
		\pdv[sep-eval-sp=\ms{here}]{f}{x,y}^{(x_2,y_2)}
	\end{example}
\end{option}
